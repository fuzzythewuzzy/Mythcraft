...
import net.mcreator.mythcraft.procedures.OpenguiOnKeyPressedProcedure;
...
public class OpenguiMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenguiOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		MythCraftMod.addNetworkMessage(OpenguiMessage.class, OpenguiMessage::buffer, OpenguiMessage::new, OpenguiMessage::handler);
	}
}
